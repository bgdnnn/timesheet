...
const ExportButton = ({ onExport, onMenuStateChange }) => {
    const commonButtonClass = "w-full flex items-center space-x-3 px-4 py-3 mt-2 rounded-lg text-gray-300 hover:bg-white/10 transition-all duration-200";
    return (
            ...
            <PopoverContent className="bg-gray-800/80 backdrop-blur-lg border-white/20 text-white w-56 p-2">
                <div className="p-2">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-xs">
                        <Button variant="ghost" className="hover:bg-white/10 w-full justify-start p-2" onClick={() => onExport('TimeEntry', 'json')}>Entries (JSON)</Button>
                        <Button variant="ghost" className="hover:bg-white/10 w-full justify-start p-2" onClick={() => onExport('TimeEntry', 'csv')}>Entries (CSV)</Button>
                        <Button variant="ghost" className="hover:bg-white/10 w-full justify-start p-2" onClick={() => onExport('Project', 'json')}>Projects (JSON)</Button>
                        <Button variant="ghost" className="hover:bg-white/10 w-full justify-start p-2" onClick={() => onExport('Project', 'csv')}>Projects (CSV)</Button>
                        <Button variant="ghost" className="hover:bg-white/10 w-full justify-start p-2" onClick={() => onExport('Hotel', 'json')}>Hotels (JSON)</Button>
                        <Button variant="ghost" className="hover:bg-white/10 w-full justify-start p-2" onClick={() => onExport('Hotel', 'csv')}>Hotels (CSV)</Button>
                    </div>
                </div>
            </PopoverContent>
        </Popover>
          ...
          {isMobileMenuOpen && (
            ...
            >
              ...
              <div className="border-t border-white/20 pt-2">
                  <ExportButton onExport={handleExport} onMenuStateChange={(open) => { if (!open) setIsMobileMenuOpen(false); }} />
                  <button
                    onClick={() => {
